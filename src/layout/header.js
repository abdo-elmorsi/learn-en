  ...
  return (
	...
	S335.983,111.18,256,111.18z"
              ...
              <Dropdown as="li" className="nav-item">
                ...
                >
                  <Image
                    src={auth?.currentUser?.photoURL || `/assets/images/avatars/01.png`}
                    width={40}
                    alt="User-Profile"
                  ...
                  <div className="caption ms-3 d-none d-md-block">
                    <h6 className="mb-0 caption-title">
                      {auth?.currentUser?.displayName !== null ? auth?.currentUser?.displayName : auth?.currentUser?.email.split('@').slice(0, 1)}
                    </h6>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu
