...
// components
import AddPhrasalVerbCom from "./AddPhrasalVerb";
import UpdatePhrasalVerbCom from "./UpdatePhrasalVerb";

const PhrasalVerbControl = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            {
                name: "actions",
                cell: (row) => <UpdatePhrasalVerbCom status={row} />,
            },
        ],
        [t, Language]
    );
...
export default PhrasalVerbControl;
